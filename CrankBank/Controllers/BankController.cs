...
namespace CrankBank.Controllers
{
    ...
    public class BankController : Controller
    {
        ...
        private static AccountSummary[] _accountSummaries = new AccountSummary[] {
                new AccountSummary{ AccountNumber = "012-123-7824", Type = AccountType.Checking, Name = "Cuenta de cheques ", Balance = 1234.56},
                new AccountSummary{ AccountNumber = "567-234-5586", Type = AccountType.Savings, Name = "Cuenta de ahorros", Balance = 5000.27},
                new AccountSummary{ AccountNumber = "9999-2222-3333-2910", Type = AccountType.Credit, Name = "Tarjeta Platinum", Balance = 875.56},
            };
